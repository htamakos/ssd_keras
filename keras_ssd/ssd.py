...
from tensorflow.contrib.keras.python.keras.layers import Convolution2D
...
from keras_ssd.ssd_layers import Normalize
from keras_ssd.ssd_layers import PriorBox
